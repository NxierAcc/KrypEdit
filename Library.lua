...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        MenuIcon.MouseButton1Click:Connect(function()
            local existing = MainFrame:FindFirstChild("MenuTab")
            if existing then
        ...
        SearchBox = New("TextBox", {
            ...
            BackgroundColor3 = "MainColor",
            PlaceholderText = "Search",
            Position = UDim2.new(0.22, 108, 0.5, 0),
            Size = UDim2.new(0.52, -157, 1, -16),
            TextScaled = true,
            Parent = TopBar,
        })
        New("UICorner", {
        ...
        Tabs = New("ScrollingFrame", {
            ...
            Position = UDim2.new(0.47, 108, 0.5, 0),
            ScrollBarThickness = 0,
            Size = UDim2.new(0.7, -251, 1, -16),
            Parent = TopBar,
        })
        ...
        Container = New("Frame", {
            ...
            Size = UDim2.new(0, 559, 1, -70),
            --Size = UDim2.new(0.7, -1, 1, -110),
            Parent = MainFrame,
        })
